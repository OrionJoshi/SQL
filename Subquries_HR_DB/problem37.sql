...
-- department ID for those employees who earn more than the maximum salary of 
...
-- Method-1
    ...
    FROM employees WHERE salary > (SELECT MAX(salary) FROM employees WHERE department_id = 40 )
