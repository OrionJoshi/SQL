-- 20. Write a query in SQL to find the name of the patients who taken an advanced appointment,
...
-- Method-2
    ...
    WHERE  s.physician=p.employeeid 
        AND s.patient=t.ssn AND s.medication=m.code
        AND s.appointment IS NOT NULL;
