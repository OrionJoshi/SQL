-- 3. Write a query in SQL to find the name of movie and director (first and last names) who directed a movie
...
-- Method-2
    ...
    SELECT m.mov_title, CONCAT(d.dir_fname, ' ', d.dir_lname) AS full_name 
    FROM movie m 
